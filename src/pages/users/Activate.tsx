...
const Activate = () => {
  ...
  return (
    <div className="flex items-center justify-center px-5 py-[10%]">
      <div className="max-w-xl p-8 text-center text-gray-800 bg-white shadow lg:max-w-3xl rounded-xl lg:p-12">
        <h3 className="text-2xl">Thanks for signing up for Rafcart!</h3>
        ...
        <div className="mt-4">
          <p className="text-base mb-6">
            We're happy you're here. Let's get your account activated.
          </p>

          <button
            className="px-2 py-2 bg-amber-400  text-white rounded text-base"
